...
each of which have the following sub-directories:
      ...
      build.vc17       - build files for Visual Studio 2022
...
version of MSIEVE
      ...
      build.cuda.vc17 - build files for Visual Studio 2022
...
Open the project file msieve.sln in Visual Studio 2022 and build
...
To do this, open the file gpu_sm.props in the build.cuda.vc17
...
names and locations for MPIR and GMP-ECM.
    ...
    Alexander Higgins, September 2023
